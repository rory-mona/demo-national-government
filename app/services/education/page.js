...
export default function EducationService() {
  ...
  const handleMonaAttestLogin = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        router.push('/services/education/dashboard')
      } else {
  ...
  const handleRegularLogin = () => {
    // Navigate directly to education dashboard
    router.push('/services/education/dashboard')
  }
          ...
          <div className="flex flex-col justify-center">
            <div className="mb-8">
              ...
              <p className="text-xl text-gray-600 mb-6">
                {isMonaAttest 
                  ? 'Please securely authenticate yourself to access educational services'
                  : 'Please enter your credentials to access educational services'
                }
              </p>
            </div>
